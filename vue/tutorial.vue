window.onload = function() {
  ...
  var loginTemplate = '<div><input type="text" placeholder="ログインID" v-model="userid"><input type="password" placeholder="パスワード" v-model="password"><button v-on:click="login">ログイン</button></div>';
